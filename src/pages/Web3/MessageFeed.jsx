            ...
            >
                {message.from.nick && (
                    <div className="my-auto flex max-h-8">
                        ...
                        <p className="my-auto max-w-36 overflow-scroll text-left text-lg font-semibold text-darken-800 scrollbar-hide max-sm:text-sm">
                            {message.from.nick}:
                        </p>
                    </div>
                )}
                <p className="my-auto max-h-96 flex-1 overflow-scroll text-left text-lg text-darken-800 scrollbar-hide max-sm:text-sm">
                    {message.content}
                </p>
