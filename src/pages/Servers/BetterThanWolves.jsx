        ...
        >
            ...
            <div className="w-xl flex flex-col justify-center gap-6">
                <div className="flex flex-grow justify-between gap-6 max-sm:flex-wrap">
                    ...
                    <div className="flex flex-col gap-4 rounded-3xl bg-lighten-800 p-4">
                        ...
                        >
                            ...
                            <p className="text-left font-header text-darken-800">
                                ...
                                formal rules. Anybody can join. Anyboy can grief
                                you.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 rounded-3xl bg-lighten-800 p-4">
                        ...
                        >
                            ...
                            <p className="text-left font-header text-darken-800">
                                This server uses a fake "hardcore mode". Every
                                time you die, you will spawn in a new, random,
                                location. But, the sequence of spawn locations
                                is synced for all players.
                                <br />
                                <i>
                                    For example, every player will spawn near
                                    (2300, -2000) after their fifth death.
                                </i>
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-4 rounded-3xl bg-lighten-800 p-4 text-darken-800">
                    ...
                    <p className="text-left font-header text-xl text-darken-800">
                        3. Connect your Microsoft account to MultiMC by clicking
                        "Manage Accounts" in the top-right corner
                    </p>
                    <p className="text-left font-header text-xl text-darken-800">
