            ...
            <div className="w-xl flex flex-col justify-center gap-6">
                    ...
                    <div className="lit-panel flex w-full flex-col gap-4 rounded-3xl p-4">
                        ...
                        >
                            ...
                            <p className="text-left font-header text-darken-800">
                                This server requires the Factorio: Space Age DLC
                                to join.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lit-panel flex flex-col gap-4 rounded-3xl p-4">
                        ...
                        >
                            <svg
                                ...
                                height="48"
                                fill="currentColor"
                                className="bi bi-person-lock h-full w-1/4 max-w-12 text-darken-700"
                                viewBox="0 0 16 16"
                            >
                                <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m0 5.996V14H3s-1 0-1-1 1-4 6-4q.845.002 1.544.107a4.5 4.5 0 0 0-.803.918A11 11 0 0 0 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664zM9 13a1 1 0 0 1 1-1v-1a2 2 0 1 1 4 0v1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1zm3-3a1 1 0 0 0-1 1v1h2v-1a1 1 0 0 0-1-1" />
                            </svg>
                            <p className="text-left font-header text-darken-800">
                                Although referrals are required to join, they
                                are easily granted via Steam friends. The server
                                is not actively moderated; message an{" "}
                ...
                <div className="lit-panel flex flex-col gap-4 rounded-3xl p-4 text-darken-800">
                    ...
                    <p className="text-left font-header text-xl text-darken-800">
                        0. Gain access to the server by either (a) joining via
                        an already-allowed stream friend or (b) joining{" "}
                    ...
                    <p className="text-left font-header text-xl text-darken-800">
                        2. From the main menu, choose "Multiplayer", and then
                        "Connect to address"
                    </p>
                    <p className="text-left font-header text-xl text-darken-800">
                        3. The server rules will be displayed in the chat the
                        first time you join. Follow them and have fun!
                    </p>
                    <p className="text-left font-header text-xl italic text-darken-800">
                        ... To join next time, choose "Public servers" from the
                        multiplayer menu. You will see your recently-played
                ...
                <div className="lit-panel flex flex-col gap-4 rounded-3xl p-4 text-darken-800">
                    ...
                    <p className="text-left font-header text-xl italic text-darken-800">
                        * Your friend must actively be on the Factorio server to
                        use this method.
                    </p>
                    <p className="text-left font-header text-xl text-darken-800">
